  ...
  for (let i = 0; i < tasks.length; i++) {
    ...
    if (title == title_c) {
      if(completed == 1) {
        ...
        <div class="todo_task">
        <span class="todo_task_title">`+title+`</span>
        <button class="btn btn_check" onclick="check_task('`+title+`')"></i></button>
        <button class="btn btn_delete" onclick="delete_task('`+title+`')"><i class="fa fa-trash"></i></button>
        <button class="btn btn_display" onclick="displayTask()"><i class="fa fa-list"></i></button>
        <div class="todo_task_description">
            <p class="task_description">
...
function check_task(title_c) {
  ...
  for (let i = 0; i < tasks.length; i++) {
    ...
    display.innerHTML += `
      <div class="todo_task">
      <span class="todo_task_title">`+title+`</span>
      <button class="btn btn_check" onclick="check_task('`+title+`')"></button>
      <button class="btn btn_delete" onclick="delete_task('`+title+`')"><i class="fa fa-trash"></i></button>
      <button class="btn btn_display" onclick="display_desc('`+title+`')"><i class="fa fa-list"></i></button>
      </div>
      `;
...
function displayTask() {
  ...
  number.innerHTML = `<marquee width=100% direction="left"> <span class="event1">No of Live Tasks = <span class="event">` + live + `</span></span></marquee><marquee width=100% direction="left"><span class="event1"> Completed Tasks = <span class="event">` + com+`</span></span></marquee>`;
  display.innerHTML = "";
